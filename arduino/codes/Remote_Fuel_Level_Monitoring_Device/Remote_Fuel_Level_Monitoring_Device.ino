...
// Check to see if there is data coming from the GPS and read it
  ...
  delay(2000);
getGPSInfo();  //Call Function which displays GPS info
...
void sendSMS(int a, float b, float c, float d){
 ...
 //  gpsInfo
    ...
    { 
        ...
        Serial.print("RLFM; "); Serial.print("100; "); Serial.print(b); Serial.print("; "); Serial.print(c, 6); Serial.print(" "); Serial.print(d, 6);
        
         }
         else if(a == 2){
         //  Serial.println("Reply to Query");
       // Serial.print("New Level is "); Serial.print(b); Serial.print(" ml"); 
         Serial.print("RLFM; "); Serial.print("200; "); Serial.print(b); Serial.print("; "); Serial.print(c, 6); Serial.print("; "); Serial.print(d, 6);
         }

         else if(a == 3){
          // Serial.println("Status Update:");
        //Serial.print("Current Level is "); Serial.print(b); Serial.print(" ml"); 
     Serial.print("RLFM; "); Serial.print("300; "); Serial.print(b); Serial.print(" "); Serial.print(c); Serial.print(" "); Serial.print(d);
         }
        Serial.write(0x1A);
